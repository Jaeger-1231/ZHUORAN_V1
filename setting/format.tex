%%%%%%%%%%%字体大小
%%%% 请首先尝试使用ctex的zihao的命令，这个设置是20年写的，不想改了。
...
\dottedcontents{chapter}[2cm]{\fontsize{12pt}{0pt}\selectfont\songti\bfseries\vspace{0.5cm}}{4.0em}{10pt}
%\dottedcontents{section}[2cm]{\fontsize{14pt}{0pt}\selectfont\songti\vspace{0.5cm}}{2.0em}{10pt}
%\dottedcontents{subsection}[2.2cm]{\fontsize{14pt}{0pt}\selectfont\songti\vspace{0.5cm}}{1.0em}{10pt}
...
%\fancyhead[RO,LE]{\songti\nouppercase\leftmark}% \leftmark自动存录各章之章名,
%\fancyhead[RO,LE]{\songti\nouppercase\leftmark}% \leftmark自动存录各章之章名,
...
%%%%%目录section缩进
% 仅调整 section 和 subsection 在目录中的缩进
\makeatletter
\renewcommand{\l@section}{\@dottedtocline{1}{3em}{1em}}   % section 右移 2em
\renewcommand{\l@subsection}{\@dottedtocline{2}{5em}{1em}} % subsection 右移 4em
\makeatother
...
%%%%%%
\ctexset{
	contentsname = {\heiti\centerline{目\ 录} },
	chapter={
